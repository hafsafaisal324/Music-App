  ...
  return (
    <SafeAreaView style={styles.background}>
      ...
      <View style={styles.touchableOpacityView}>
        ...
        <TouchableOpacity
          style={[
            {marginTop: 15, borderColor: colors.spotifyWhite, borderWidth: 0.7},
            styles.genericTouchableOpacity,
          ]}
          onPress={() => openModal()}>
          <AntDesign
            name="google"
            size={23}
            color={colors.spotifyWhite}></AntDesign>
        ...
        <TouchableOpacity
          ...
          <MaterialCommunityIcons
            name="facebook"
            size={26}
            color={colors.spotifyWhite}></MaterialCommunityIcons>
          <Text style={styles.touchableOpacityText}>
            {' '}
            {loginStrings.signInWithFacebook}
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => openModal()}
