...
const privacyPolicyContent = {
    ...
    sections: [
      {
        ...
        text: 'Welcome to SoulTribeNetwork (hereinafter referred to as "we" or "the app"). This privacy policy aims to explain how we collect, use, share, and protect your personal information. Please read the following content carefully to understand our privacy practices.',
      },
      {
  ...
  zh: {
    ...
    sections: [
      {
        sectionTitle: "介绍",
        text: '欢迎使用 SoulTribeNetwork（以下简称"我们"或"本应用"）。本隐私协议旨在向您解释我们如何收集、使用、共享和保护您的个人信息。请仔细阅读以下内容，以了解我们的隐私做法。',
      },
      {
        sectionTitle: "登录信息",
